...
const SYSTEM =
  ...
  "ACCURACY IS NON-NEGOTIABLE: never invent specifics — no made-up street names/addresses, property types, prices, sale details, buyer/seller names, or events. Never claim a specific home was sold/listed unless the research says so. GEOGRAPHIC SENSE: major boulevards like Ventura Blvd are commercial — never place a single-family or ranch home 'on Ventura Blvd'; homes are on residential side streets. Never write anything impossible or that Anita couldn't stand behind. When unsure, stay general and true.\n" +
